...
const contractorSchema = z.object({
    contractor_type: z.enum(['majur', 'sube'], { required_error: 'Please select a contractor type' }),
...
const ContractorForm = ({ 
    ...
    const [selectedType, setSelectedType] = useState(initialData?.contractor_type || '');
    ...
    return (
        <FormLayout
            title="Contractor"
            subtitle={isEditMode ? 'Edit contractor information' : 'Create new contractor'}
            icon={Users}
